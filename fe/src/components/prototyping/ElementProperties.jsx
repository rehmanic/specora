  ...
  return (
    <div className="border-border border-b">
      <div className="border-border border-b p-3">
        <span className="text-muted-foreground text-xs font-semibold tracking-wider uppercase">Properties</span>
      </div>
      <div className="space-y-3 p-3">
        {/* Type badge */}
        <div className="flex items-center justify-between">
          <span className="text-muted-foreground text-xs capitalize">{element.type}</span>
