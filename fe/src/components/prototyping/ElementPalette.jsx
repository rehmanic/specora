...
export default function ElementPalette({ onAddElement }) {
  return (
    <div className="border-border bg-card flex shrink-0 items-center gap-1 overflow-x-auto border-b px-3 py-2">
      <span className="text-muted-foreground mr-2 shrink-0 text-xs font-semibold tracking-wider uppercase">
        Elements
      </span>
          ...
          <Tooltip key={type}>
            <TooltipTrigger asChild>
              <button
                ...
                className="hover:bg-muted/60 active:bg-muted flex h-8 w-8 shrink-0 items-center justify-center rounded-md transition-colors"
              >
