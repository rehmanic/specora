...
export const getPrototypes = (projectId) => request(`/prototyping/prototypes/${projectId}`);
...
export const deletePrototype = (prototypeId) => request(`/prototyping/prototypes/${prototypeId}`, { method: "DELETE" });

// ─── Screens ──────────────────────────────────────────────

export const getScreens = (prototypeId) => request(`/prototyping/prototypes/${prototypeId}/screens`);
...
export const deleteScreen = (screenId) => request(`/prototyping/screens/${screenId}`, { method: "DELETE" });
...
export const getScreenRequirements = (screenId) => request(`/prototyping/screens/${screenId}/requirements`);
