...
export const DIAGRAMS = {
  ...
  REQUIREMENTS: (projectId, diagramId) => `/diagrams/${e(projectId)}/${e(diagramId)}/requirements`,
};

export const DOCS = {
  BY_PROJECT: (projectId) => `/docs/${e(projectId)}`,
  SINGLE: (projectId, docId) => `/docs/${e(projectId)}/${e(docId)}`,
  REQUIREMENTS: (projectId, docId) => `/docs/${e(projectId)}/${e(docId)}/requirements`,
  GENERATE: (projectId, docId) => `/docs/${e(projectId)}/${e(docId)}/generate`,
  EDIT_WITH_AI: (projectId, docId) => `/docs/${e(projectId)}/${e(docId)}/edit-with-ai`,
  EXPORT: (projectId, docId, format) => `/docs/${e(projectId)}/${e(docId)}/export/${e(format)}`,
};
...
export const MEETINGS = {
  ...
  EXTRACT_REQUIREMENTS: (meetingId) => `/meetings/${e(meetingId)}/extract-requirements`,
};
...
export const RBAC = {
  ...
  ROLE_PERMISSION: (roleId, permissionId) => `/rbac/roles/${e(roleId)}/permissions/${e(permissionId)}`,
...
export const REQUIREMENTS = {
  ...
  HISTORY: (projectId, reqId) => `/requirements/${e(projectId)}/${e(reqId)}/history`,
  ROLLBACK: (projectId, reqId, historyId) => `/requirements/${e(projectId)}/${e(reqId)}/rollback/${e(historyId)}`,
  COMMENTS: (projectId, reqId) => `/requirements/${e(projectId)}/${e(reqId)}/comments`,
  TRACEABILITY: (projectId, reqId) => `/requirements/${e(projectId)}/${e(reqId)}/traceability`,
  TRACEABILITY_LINK: (projectId, linkId) => `/requirements/${e(projectId)}/traceability/${e(linkId)}`,
  TRACEABILITY_GRAPH: (projectId) => `/requirements/${e(projectId)}/traceability/graph`,
...
export const VERIFICATION = {
  ...
  ARM_REQUIREMENT: (projectId, reqId) => `/verification/arm/${e(projectId)}/requirement/${e(reqId)}`,
  AI_REQUIREMENT: (projectId, reqId) => `/verification/ai/${e(projectId)}/requirement/${e(reqId)}`,
};
...
export const PROTOTYPING = {
  ...
  SCREENS: (prototypeId) => `/prototyping/prototypes/${e(prototypeId)}/screens`,
  SCREEN: (screenId) => `/prototyping/screens/${e(screenId)}`,
  REORDER_SCREENS: "/prototyping/screens/reorder",
  SCREEN_REQUIREMENTS: (screenId) => `/prototyping/screens/${e(screenId)}/requirements`,
};
