...
import { Plus, UsersRound, LogOut, FolderOpen, MessageSquare, Video, MessageCircle, Moon, Sun, Search } from "lucide-react";
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-20 animate-fade-in">
      ...
      <h3 className="text-xl font-semibold font-display mb-2">No projects yet</h3>
      ...
      <nav className="sticky top-0 z-50 border-b bg-card/80 backdrop-blur-md">
        <div className="flex items-center justify-between px-6 h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="ghost"
              className="flex items-center gap-2 h-9 px-4 text-destructive hover:text-destructive hover:bg-destructive/10"
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 animate-fade-in" style={{ animationDelay: '0.1s' }}>
            ...
            <StatsCard
              icon={Video}
              label="Meetings"
              value={projects.length > 0 ? Math.floor(projects.length * 1.2) : 0}
              color="success"
            />
            <StatsCard
              icon={MessageCircle}
              label="Feedback Items"
              value={projects.length > 0 ? Math.floor(projects.length * 3) : 0}
              color="warning"
            />
          </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-9 w-[200px] sm:w-[250px] h-9"
                  />
                </div>

                {user?.role === "manager" && (
                  <Link href="/create">
                    <Button className="gap-2 h-9 gradient-primary border-0">
                      <Plus className="h-4 w-4" />
